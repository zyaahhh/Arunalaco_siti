      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{ route('detail_penjualan.update', $detail_penjualan->id) }}" method="POST">
              @csrf
              @method('PUT')
              ...
              <div class="mb-3">
                ...
                <select class="form-control" name="id_penjualan" required>
                  ...
                  @foreach($penjualan as $p)
                    <option value="{{ $p->id }}"
                      {{ $p->id == $detail_penjualan->id_penjualan ? 'selected' : '' }}>
              ...
              <div class="mb-3">
                ...
                <select class="form-control" name="id_barang" required>
                  ...
                  @foreach($barang as $b)
                    <option value="{{ $b->id }}"
                      {{ $b->id == $detail_penjualan->id_barang ? 'selected' : '' }}>
                      {{ $b->nama_barang }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" name="jumlah"
                       value="{{ old('jumlah', $detail_penjualan->jumlah) }}" required min="1">
              </div>
